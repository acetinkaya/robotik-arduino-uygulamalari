...
DHT Kütüphanesini Arduino menülerinden "Tools" -> "Manage Libraries..." -> arama menüsünden -> "DHT sensor library by Adafruit" bularak "INSTALL" ile kurulum sağlayın, Kurulum 
